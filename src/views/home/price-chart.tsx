...
const Chart = () => {
  ...
  const renderVerticalLines = () => {
    ...
    for (let i = 0; i < dateArray.length; i++) {
      lineComponents.push(
        <Line key={i} x={dateArray[i]} stroke="#262626" strokeWidth={1} />
      );
    }
      ...
      <div className="divide-y divide-shade-800 rounded-xl border border-shade-800 bg-black text-base text-white">
        <div className="p-5">
          ...
          <div className="flex items-center justify-between ">
            ...
            <div className="flex items-center text-xs text-shade-500">
